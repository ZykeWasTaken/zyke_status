RegisterStatusType("high", true, {value = 0.0}, function()
    -- print("pluh")
...
RegisterCommand("high_add", function(source, args)
    exports["zyke_status"]:AddToStatus(source, "high." .. args[1], tonumber(args[2]))
end, false)